...
const timelineNotes: TimelineNote[] = [
  ...
  { date: '2024/04', text: 'Digitartテクノロジー愛好会(当時: PiedPiper 青山テック愛好会) 入会' },
  { date: '2024/11', text: 'Digitartテクノロジー愛好会(当時: PiedPiper 青山テック愛好会) 副代表就任' },
  { date: '2025/03', text: 'VPSサーバ契約' },
  { date: '2025/04', text: 'Digitartテクノロジー愛好会(当時: PiedPiper 青山テック愛好会) 代表就任' },
